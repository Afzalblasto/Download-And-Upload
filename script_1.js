...
const SUPABASE_KEY =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InF5amtvcHhsaXBuaWdjcG9qY3pxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTUxNzE0NDMsImV4cCI6MjA3MDc0NzQ0M30.7wD7aHeZrV81xAuuicjr9T1LLYXVDd6-9RoKu0T07Y0";
...
// Password protection
const ACCESS_PASSWORD = "ICHIGODUZUMAKI"; // change this to your secret
...
// Upload files with password & progress
startUpload.addEventListener("click", async () => {
  ...
  let totalSize = Array.from(fileInput.files).reduce(
    (sum, f) => sum + f.size,
    0
  );
  let uploadedBytes = 0;
